...
part of 'DAOSeller.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

DAOSeller _$DAOSellerFromJson(Map<String, dynamic> json) => DAOSeller(
...
Map<String, dynamic> _$DAOSellerToJson(DAOSeller instance) => <String, dynamic>{
      'success': instance.success,
      'error': instance.error,
      'data': instance.data,
    };

SaleProduct _$SaleProductFromJson(Map<String, dynamic> json) => SaleProduct(
