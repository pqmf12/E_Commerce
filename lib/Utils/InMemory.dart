...
class InMemory{
  ...
  // wishlist = prefs.getString("wishlist") ?? "";
  ...
  // custom_fields = prefs.getString("custom_fields") ?? "";
  ...
  Future setSession(String session) async {
   ...
   Future setUser( UserInfo user,) async {
     ...
     // prefs.setString("wishlist", user.wishlist ?? "");
     ...
     // prefs.setString("custom_field", user.custom_fields ?? "");
